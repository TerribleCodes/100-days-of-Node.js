...
function totalPrice(item_price){ // index and the array will be passed to the function and it's not necessary to mention them in the function
    total += item_price
}
...
console.log(`Hello ${fName} and ${lName}. You have $${taxRate} to pay; and the salary will be ${taxRate * salary}`)
```
